...
class GetWahana3DAdminDetailResponse implements JsonSerializable
{
    ...
    public function __construct(
        ...
        ?string $deskripsi_karya_url = null,
        ?string $upload_karya_url = null,
        ?string $form_keaslian_url = null,
        array $team_members
    ) {
        $this->team_name = $team_name;
        $this->team_code = $team_code;
        $this->deskripsi_karya = $deskripsi_karya;
        $this->deskripsi_karya_url = $deskripsi_karya_url ?? null;
        $this->upload_karya_url = $upload_karya_url ?? null;
        $this->form_keaslian_url = $form_keaslian_url ?? null;
