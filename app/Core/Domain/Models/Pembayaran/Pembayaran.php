...
class Pembayaran
{
    ...
    public function __construct(PembayaranId $id, int $list_bank_id, int $list_event_id, int $status_pembayaran_id, string $bukti_pembayaran_url, int $harga)
    {
        $this->id = $id;
     ...
     * @throws Exception
     */
    public static function create(int $list_bank_id, int $list_event_id, int $status_pembayaran_id, string $bukti_pembayaran_url, int $harga): self
    {
        return new self(
