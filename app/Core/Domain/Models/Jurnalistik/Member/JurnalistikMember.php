...
class JurnalistikMember
{
    ...
    public function __construct(JurnalistikMemberId $id, ?JurnalistikTeamId $jurnalistik_team_id, UserId $user_id, string $kabupaten_id, string $provinsi_id, string $name, string $asal_instansi, string $id_line, string $id_card_url, string $follow_sosmed_url, string $share_poster_url)
    {
        $this->id = $id;
     ...
     * @throws Exception
     */
    public static function create(?JurnalistikTeamId $jurnalistik_team_id, UserId $user_id, string $kabupaten_id, string $provinsi_id, string $name, string $asal_instansi, string $id_line, string $id_card_url, string $follow_sosmed_url, string $share_poster_url): self
    {
        return new self(
